...
class Error_dynamics:
    ...
    def plot_timeseries_error(self):
        ...
        ax[0].plot(t, self.error[0], 'b', label='membrane potential',linewidth=3.0)
        ...
        ax[1].plot(t, self.error[1], 'b', label='membrane potential',linewidth=3.0)
        ...
        ax[2].plot(t, self.error[2], 'b', label='membrane potential',linewidth=3.0)
        ...
        ax[2].xaxis.set_major_locator(MaxNLocator(nbins=11))
        ax[2].yaxis.set_major_locator(MaxNLocator(nbins=3))
        ax[2].grid(True, which='both', linestyle='--', linewidth=0.5)

        ax[3].plot(t, self.error[3], 'b', label='membrane potential',linewidth=3.0)
        ...
        ax[3].xaxis.set_major_locator(MaxNLocator(nbins=11))
        ...
        fig.text(0.49, 0.9, '(a)', fontsize=30, weight='bold')

        fig.align_ylabels(ax[:])
        plt.tight_layout()
        fig.savefig('images/fig_5_a.eps', dpi=300, format='eps')
        fig.savefig('images/fig_5_a.png', dpi=300, format='png')
        plt.show()
    ...
    def plot_timeseries_uncertainty(self):
        ...
        ax[0].plot(t, self.uncertainty[0], 'b',linewidth=3.0)
        ...
        ax[1].plot(t, self.uncertainty[1], 'b',linewidth=3.0)
        ...
        ax[2].plot(t, self.uncertainty[2], 'b',linewidth=3.0)
        ...
        ax[3].plot(t, self.uncertainty[3], 'b',linewidth=3.0)
        ...
        ax[3].yaxis.set_major_locator(MaxNLocator(nbins=3))
        ax[3].grid(True, which='both', linestyle='--', linewidth=0.5)
        fig.text(0.49, 0.9, '(c)', fontsize=30, weight='bold')
        ax[-1].set_xlabel("t", fontsize=26)
        fig.align_ylabels(ax[:])
        plt.tight_layout()
        fig.savefig('images/fig_5_c.png', dpi=300, format='png')
        fig.savefig('images/fig_5_c.eps', dpi=300, format='eps')
        plt.show()
    ...
    def plot_timeseries_g(self):
        ...
        ax[0].plot(t, self.controlers[0], 'b', label='membrane potential',linewidth=3.0)
        ...
        ax[1].plot(t, self.controlers[1], 'b', label='membrane potential',linewidth=3.0)
        ...
        ax[2].plot(t, self.controlers[2], 'b', label='membrane potential',linewidth=3.0)
        ...
        ax[3].plot(t, self.controlers[3], 'b', label='membrane potential',linewidth=3.0)
        ...
        ax[-1].set_xlabel("t", fontsize=26)
        fig.align_ylabels(ax[:])
        fig.text(0.49, 0.9, '(b)', fontsize=30, weight='bold')
        plt.tight_layout()
        fig.savefig('images/fig_5_b.eps', dpi=300, format='eps')
        fig.savefig('images/fig_5_b.png', dpi=300, format='png')
        plt.show()
