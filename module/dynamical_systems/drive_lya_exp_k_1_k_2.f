        ...
        DOUBLE PRECISION :: A,B,D,Alpha,Beta,Input,C,Sigma
        DOUBLE PRECISION :: z_MU, Theta
        ...
        Open(7,File="drive_lya_K1_K2.txt",Status='unknown')
C
        N=5
        NN=(N*N)+N
C
...
C
        ...
        END DO
        WRITE(7,*)K1,k2, EXPO(1), EXPO(2), EXPO(3), EXPO(4), EXPO(5)
        K2 = K2 +0.01
        end do
        k1=k1+0.01
        END DO
